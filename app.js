...
const projects = {
    ...
    x3 : {
        ...
        description: "<p><span class='color bold'>E-commerce</span> site made on request with guidelines. The sites purpose is to sell fully customisable handmade woodworks, and to promote the owners custom builds and personalisation business. Ryan's woodworks was built from the ground up, using bootstrap, HTML, CSS, Javascript, and the graphics editted and designed on photoshop.</p>",
        button: "<a target='blank' href='https://wrecket.github.io/ryanswoodworksfinal/'><button type='button' class='btn project-btn btn-warning'>Click to view</button></a>"
    },
    x4 : {
